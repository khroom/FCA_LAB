...
if __name__ == '__main__':
    ...
    train_df = df[(df[date_name] > '2024-11-01')&(df[date_name] < dif_date)&(df[obj_name].isin(el_list))]
    ...
    reds = ['#ff0000', '#990000', '#ff3355', '#7a0a0f', '#541008', '#a3481d', '#b04530', '#cd5c5c', '#e52b50', '#e32636', '#ff2400', '#a91d11', '#993000', '#ff7433', '#f36223', '#ff845c', '#fc2847', '#e63244', '#ee204d', '#fb607f']
    greens = ['#008000','#00a550','#77dd77','#1fc41f','#143306','#475936','#424632','#31372b','#009900','#57a639','#5da130','#bef574','#687d1d','#37571d','#82c44d','#67a112','#00a550','#50c878','#2b874a','#2e8b57']
    reds_count = 0
    greens_count = 0
